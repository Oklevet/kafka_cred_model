...
public class HelloWorld {
    public static void main(String[] args) throws IgniteException {
        ...
        TcpDiscoverySpi discoverySpi = new TcpDiscoverySpi().setLocalAddress("127.0.0.1:5432/kafka_cred_model");
        igniteCfg.setDiscoverySpi(discoverySpi);
        // Setting up an IP Finder to ensure the client can locate the servers.
        TcpDiscoveryMulticastIpFinder ipFinder = new TcpDiscoveryMulticastIpFinder();
        ipFinder.setAddresses(Collections.singletonList("127.0.0.1:5432/kafka_cred_model"));
